    ...
    return (
      <Card className="border border-dashed border-border/60">
        <CardContent className="py-10 px-6 flex flex-col items-center text-center gap-4">
          ...
          <div>
            <h3 className="font-heading font-semibold text-base">No debts added yet</h3>
      ...
      <Card className="border border-destructive/20 bg-destructive/5">
        <CardContent className="p-4 flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="font-heading font-semibold text-sm">Please fix these issues</h3>
    ...
    return (
      <Card className="border border-primary/15 bg-accent/40">
        <CardContent className="py-10 px-6 flex flex-col items-center text-center gap-4">
          ...
          <div>
            <h3 className="font-heading font-semibold text-base">Ready to compute your plan</h3>
